...
neg:
  ...
  ;tstr:	 	   insn,    memop,  iy,     ix,   hl,    de,    bc,  flags,acc,  sp
	;----tstr	<0edh,044h>,038a2h,05f6bh,0d934h,057e4h,0d2d6h,04642h,05ah,05ah,009cch
  ;--- Instruction under test (iut)
  DEFB	0edh,044h, 00, 00h

  ;--- Machine state:
  ;--   memop,    iy,    ix       hl       de     bc
  DEFW	038a2h,05f6bh,0d934h,057e4h,0d2d6h,04642h
  DEFB	05ah   ;-- Flags
  DEFB	05ah    ;-- acc
  DEFW	009cch  ;-- sp
